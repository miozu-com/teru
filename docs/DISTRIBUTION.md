...
- `brew tap miozu/tap && brew install teru`
...
### winget
- Package name: `miozu.teru` (available, checked 2026-03-30)
...
- `scoop bucket add miozu https://github.com/miozu-com/scoop-bucket`
- `scoop install teru`
